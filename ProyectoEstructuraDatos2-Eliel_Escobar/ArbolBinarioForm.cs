...
{
    public partial class ArbolBinarioForm : Form
    {
        CArbol arbol;
        Graphics nodo;
        public ArbolBinarioForm()
        {
            InitializeComponent();
            nodo = CreateGraphics();
            arbol = new CArbol(nodo, Font);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (txtNotaUno.Text != "" && txtNotaDos.Text != "" && txtNotaTres.Text != "" && txtNombre.Text != "")
            {
                ...
                arbol.InsertarDatos(estudiante[i].notaFinal);
                Refresh();
        ...
        private void ArbolBinarioForm_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            arbol.PosOrden(ListRecorrido);
        }

        private void btnPreOrden_Click(object sender, EventArgs e)
        {
            arbol.PreOrden(ListRecorrido);
        }
